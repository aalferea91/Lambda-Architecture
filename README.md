...
Once the notebook is created, we can open it in a  pyspark instance and execute the code in the following jupyternotebook: (![notebook](https://github.com/aalferea91/Lambda-Architecture/blob/main/Spark%20Streaming.ipynb))
